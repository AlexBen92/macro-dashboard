  ...
  return (
    <div className="space-y-2">
      {data.map((d, i) => {
        ...
        return (
          <div key={d.currency} className="flex items-center gap-2.5 font-mono text-[0.78rem]">
            <span className="w-6 text-center">{FLAG[d.currency] || ''}</span>
            <span className="w-9 font-bold text-[#e8e8f0]">{d.currency}</span>
      ...
      {data.length >= 2 && (
        <div className="mt-3 font-mono text-[0.72rem] text-[#d4a017] border-t border-[#1a1a30] pt-2">
